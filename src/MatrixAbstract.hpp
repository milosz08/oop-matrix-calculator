...
namespace matrixAbstractPackage {
    ...
    class MatrixAbstract {
    public:
        MatrixAbstract(unsigned short int &, unsigned short int &); /** @skip Sygnatura konstr. */
        MatrixAbstract(const MatrixAbstract<M> &); /** @skip Sygnatura konstr. kopiującego */

        virtual void printMtrx(HANDLE &, const bool, const bool) const final; /** @skip Drukowanie macierzy */
        virtual double scalarValuePush(HANDLE &) final; /** @skip Wprowadzanie wartości skalara */
        ...
        virtual ~MatrixAbstract(); /** @skip Wirtualny destruktor */
