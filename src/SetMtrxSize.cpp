...
std::string saveMtrxInfo(unsigned short int &type, unsigned short int &val) {
    ...
    switch (type) {
        case 1: { /** @skip type 1 = macierz prostokątna */
            output = "Macierz prostokątna ";
            break;
        }
        case 2: { /** @skip type 2 = macierz kwadratowa */
            output = "Macierz kwadratowa ";
            break;
        }
        case 3: { /** @skip type 3 = macierz diagonalna */
            output = "Macierz diagonalna ";
            break;
        }
    }
    ...
    switch (val) {
        case 1: { /** @skip val 1 = jedynie wartości stałoprzecinkowe */
            output += "jedynie wartościami stałoprzecinkowymi.";
            break;
        }
        case 2: { /** @skip val 2 = wartości stałoprzecinkowe oraz zmiennoprzecinkowe */
            output += "zarowno wartościami stało oraz zmiennoprzecinkowymi.";
            break;
        }
    }
