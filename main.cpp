 ...
 *            GitHub pod adresem: https://github.com/Milosz08/Kalkulator-Macierzy.
 *
 ...
 *        przekazywanych argumentów (klasy/wartości).<br>
 *
 ...
 *        przekątną - diagonalną posiada wartości zerowe).<br>
 *
