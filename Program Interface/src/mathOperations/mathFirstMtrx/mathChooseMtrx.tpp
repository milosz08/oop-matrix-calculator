 ...
 *        kwadratowe).<br>
 *
 *        Funkcja posiada walidację strumienia wejścia. Jeśli użytkownik nie poda liczby z zakresu 1-6
...
unsigned short int mathChooseMtrx(MatrixAbstract<T>* obj, HANDLE& hOut) {
  ...
  std::vector<std::string>strArr; /** @skip Tablica przechowująca zawartość menu do wydrukowania */
  bool error{false};
